...
const SerifTwoWhiteDef = dependencies(SerifTwoBaseDef, function SerifTwoWhiteDef() {
    return <use id="serif-two-white" transform="translate(.011 .011)" fill={textFill} stroke={textOutline} strokeWidth=".022" href="#serif-two-base" />;
});
const SerifThreeWhiteDef = dependencies(SerifThreeBaseDef, function SerifThreeWhiteDef() {
    return <use id="serif-three-white" transform="translate(.011 .011)" fill={textFill} stroke={textOutline} strokeWidth=".022" href="#serif-three-base" />;
});
const SerifFiveWhiteDef = dependencies(SerifFiveBaseDef, function SerifFiveWhiteDef() {
    return <use id="serif-five-white" transform="translate(.011 .011)" fill={textFill} stroke={textOutline} strokeWidth=".022" href="#serif-five-base" />;
});
...
const CowboyDef = dependencies(LassoDef, function CowboyDef() {
    return <g id="cowboy">
        ...
        <use transform="translate(2.1698 4.0004)" href="#lasso" />
    </g>;
});
...
const BuilderDef = dependencies(HammerDef, function BuilderDef() {
    return <g id="builder">
        ...
        <use transform="translate(5.8835 4.0002)" href="#hammer" />
    </g>;
});
...
const EngineerDef = dependencies(WrenchDef, function EngineerDef() {
    return <g id="engineer">
        ...
        <use transform="translate(7.7033 4.0001)" href="#wrench" />
    </g>;
});
...
const HandDef = dependencies(HandBaseDef, function HandDef({ hand }) {
    const [id, fill]
        ...
        : ['', ''];
    return <use id={id} transform="translate(.041563 .0415)" href="#hand-base"
...
const ShieldHazzard = dependencies([ShieldVpDef, ['value']], function ShieldHazzard({ value }) {
    return <use transform="matrix(1.2093 0 0 1.2093 12.389 14.751)" href={`#vp-${value}`} />;
});

const WorkerDef = dependencies(BagTileFrameDef, LassoDef, HammerDef, WrenchDef, function WorkerDef() {
    return <g id="worker">
        <use transform="scale(.27335)" href="#bag-tile-frame" />
        <use transform="matrix(.19612 0 0 .19612 2.1016 .60395)" href="#lasso" />
        <use transform="matrix(.19611 0 0 .19611 .50503 2.5313)" href="#hammer" />
        <use transform="matrix(.19611 0 0 .19611 3.745 2.973)" href="#wrench" />
    </g>;
});
...
const HazzardDef = dependencies([HandDef, { hand: 'White' }], function HazzardDef() {
    return <g id="hazzard">
        ...
        <use transform="rotate(-11.47 11.933 -8.2639)" href="#hand-white" />
    </g>;
});

const HazzardTakeDef = dependencies(HazzardDef, TakeArrowDef, function HazzardTakeDef() {
    return <g id="hazzard-take">
        <use transform="translate(0 1.111)" href="#hazzard" />
        <use transform="translate(4.8306)" href="#take-arrow" />
    </g>;
});
...
const Cattle3to5Def = dependencies(CattleDef, SerifThreeBaseDef, SerifFiveBaseDef, function Cattle3to5Def() {
    return <g id="cattle-3-5">
        <use href="#cattle" />
        <use transform="matrix(.57652 0 0 .57652 .589 2.3333)" fill={black} href="#serif-three-base" />
        <rect x="2.1169" y="3.4202" width=".53131" height=".23331" />
        <use transform="matrix(.5765 0 0 .5765 2.6506 2.355)" fill={black} href="#serif-five-base" />
    </g>;
});
...
const CattleTake3Def = dependencies(CattleDef, SerifThreeBaseDef, TakeArrowDef, function CattleTake3Def() {
    return <g id="cattle-take-3">
        <use transform="matrix(1.0001 0 0 1.0001 4.0635e-6 8.624e-8)" href="#cattle" />
        <use transform="matrix(.57652 0 0 .57652 1.6113 2.3335)" fill={black} href="#serif-three-base" />
        <use transform="matrix(.96395 0 0 .96395 3.7361 .40133)" href="#take-arrow" />
    </g>;
});
...
const BuildingUpgrade2Def = dependencies(BuildingDef, BuilderDef, SansTwoDef, PlaceArrowDef, function BuildingUpgrade2Def() {
    return <g id="building-upgrade-2">
        <use transform="translate(.62986 1.3872)" href="#building" />
        <use transform="matrix(.16877 0 0 .16877 2e-6 1e-6)" href="#builder" />
        <use transform="matrix(.30824 0 0 .30824 1.3666 1.318)" href="#sans-two" />
        <use transform="translate(6.322 5.8047)" href="#place-arrow" />
    </g>;
});
...
const CertificateGain2Def = dependencies(SansTwoDef, AdvanceArrowDef, function CertificateGain2Def() {
    return <g id="certificate-gain-2">
        ...
        <path d="m3.1695 4.3037 3.087-2.0697v2.97l-3.087 2.1281z"
            fill={modelLightSide} />
        <use transform="matrix(.59642 0 0 .59642 2.2217 1.9784)" href="#sans-two" />
        <use transform="translate(.781 6.9333)" href="#advance-arrow" />
    </g>;
});
...
const CertificatePerm1Def = dependencies(SansOneDef, CertificateDef, SansInfDef, function CertificatePerm1Def() {
    return <g id="certificate-perm-1">
        <use transform="translate(0 1.3461)" href="#sans-one" />
        <use transform="translate(4.0908)" href="#certificate" />
        <use transform="translate(11.106 3.0201)" href="#sans-inf" />
    </g>;
});
...
const CertificatePerm2Def = dependencies(SansTwoDef, CertificateDef, SansInfDef, function CertificatePerm2Def() {
    return <g id="certificate-perm-2">
        <use transform="translate(0 1.3644)" href="#sans-two" />
        <use transform="translate(4.6386)" href="#certificate" />
        <use transform="translate(11.654 3.0201)" href="#sans-inf" />
    </g>;
});
...
const BranchletPlaceDef = dependencies(BranchletDef, PlaceArrowDef, function BranchletPlaceDef() {
    return <g id="branchlet-place">
        <use href="#branchlet" />
        <use transform="translate(5.6285 4.5861)" href="#place-arrow" />
    </g>;
});
...
const Cowboy = dependencies(CowboyDef, function Cowboy() { return <use href="#cowboy" />; });
const Builder = dependencies(BuilderDef, function Builder() { return <use href="#builder" />; });
const Engineer = dependencies(EngineerDef, function Engineer() { return <use href="#engineer" />; });

const BagTileFrame = dependencies(BagTileFrameDef, function BagTileFrame() { return <use href="#bag-tile-frame" />; });
...
const Bandit = dependencies(RevolverBaseDef, function Bandit({ kind }) {
    const fill
        ...
        : '';
    return <use transform="matrix(2.6486 0 0 2.6486 2.1861 5.8539)" href="#revolver-base"
        fill={fill} stroke={black} strokeWidth=".048" />;
});

const HandTrail = dependencies([HandDef, ['hand']], function HandTrail({ bandit, hand }) {
    return <use transform={`matrix(4.2965 0 0 4.2965 12.389 ${bandit ? '7.645' : '2.2446'})`} href={
...
const StationMasterTile1 = dependencies(
    ...
    function StationMasterTile1() {
        return <>
            <use transform="translate(2.8102 3.7521)" href="#hazzard" />
            <use transform="translate(7.6408 2.6411)" href="#take-arrow" />
            ...
            <use transform="translate(14.645 4.6159)" href="#revolver-base"
                fill={black} />
            <use transform="translate(17.878 2.6656)" href="#take-arrow" />
            <use transform="translate(2.5527 15.277)" href="#objective" />
            <use transform="translate(5.1985 16.335)" href="#objective" />
            <use transform="translate(11.522 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 14.175 16.069)" href="#vp-3" />
        </>;
    });
...
const StationMasterTile2 = dependencies(CertificatePerm1Def,
    ...
    function StationMasterTile2() {
        return <>
            <use transform="translate(3.0534 2.5437)" href="#certificate-perm-1" />
            <use transform="matrix(.68263 0 0 .68263 2.3324 17.13)" href="#sans-two" />
            <use transform="matrix(.83095 0 0 .83095 5.5741 15.755)" href="#certificate" />
            <use transform="translate(11.963 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 14.396 16.069)" href="#vp-3" />
        </>;
    });
    ...
    function StationMasterTile3() {
        return <>
            ...
            <rect x="2.011" y="14.903" width="5.8796" height="7.1068" ry=".8"
                fill={banditGreenFill} style={{ paintOrder: 'stroke' }} />
            <use transform="translate(3.3461 15.791)" href="#revolver-base"
                fill={black} />
            <rect x="5.7152" y="16.49" width="5.8796" height="7.1068" ry=".8"
                fill={banditOrangeFill} style={{ paintOrder: 'stroke' }} />
            <use transform="translate(7.0502 17.379)" href="#revolver-base"
                fill={black} />
            <use transform="translate(12.606 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 14.717 16.069)" href="#vp-3" />
        </>;
    });
...
const StationMasterTile4 = dependencies(CertificatePerm1Def,
    ...
    function StationMasterTile4() {
        return <>
            <use transform="translate(3.0534 2.5437)" href="#certificate-perm-1" />
            <use transform="translate(2.011 14.903)" href="#hazzard" />
            <use transform="translate(5.7152 16.49)" href="#hazzard" />
            <use transform="translate(12.606 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 14.717 16.069)" href="#vp-3" />
        </>;
    });
...
const StationMasterTile5 = dependencies(CoinDef, SerifTwoWhiteDef,
    ...
    function StationMasterTile5() {
        return <>
            <use transform="translate(6.7 2.4504)" fill="#ffffff" href="#coin" />
            <use transform="translate(9.7167 4.7922)" fill="#ffffff" href="#serif-two-white" />
            <use transform="translate(2.9036 15.697)" href="#worker" />
            <use transform="translate(10.821 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 13.825 16.069)" href="#vp-1" />
        </>;
    });
...
const StationMasterTile6 = dependencies(CertificatePerm1Def,
    ...
    function StationMasterTile6() {
        return <>
            <use transform="translate(3.0534 2.5437)" href="#certificate-perm-1" />
            <use transform="translate(2.3557 15.14)" href="#station" />
            <use transform="translate(5.2648 17.136)" href="#station" />
            <use transform="translate(11.916 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 14.372 16.069)" href="#vp-3" />
        </>;
    });
...
const StationMasterTile7 = dependencies(CertificateGain2Def,
    ...
    function StationMasterTile7() {
        return <>
            <use transform="translate(7.8305 1.5326)" href="#certificate-gain-2" />
            <use transform="translate(2.7299 15.896)" href="#building" />
            <use transform="translate(11.168 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 13.998 16.069)" href="#vp-2" />
        </>;
    });
...
const StationMasterTile8 = dependencies(CertificatePerm2Def, [ShieldVpDef, { value: '0' }],
    function StationMasterTile8() {
        return <>
            <use transform="translate(2.7795 2.5437)" href="#certificate-perm-2" />
            <use transform="translate(7.8992 15.508)" href="#vp-0" />
        </>;
    });
...
const StationMasterTile9 = dependencies(CoinDef, SerifOneWhiteDef, SerifTwoWhiteDef, [ShieldVpDef, { value: '0' }],
    function StationMasterTile9() {
        return <>
            <use transform="translate(6.7 2.4504)" href="#coin" />
            <use transform="translate(8.5186 4.8773)" href="#serif-one-white" />
            <use transform="translate(10.916 4.7674)" href="#serif-two-white" />
            <use transform="translate(7.8992 15.508)" href="#vp-0" />
        </>;
    });
...
const StationMasterTile10 = dependencies(BranchletPlaceDef,
    ...
    function StationMasterTile10() {
        return <>
            <use transform="translate(7.7342 3.2527)" href="#branchlet-place" />
            <use transform="translate(2.936 16.308)" href="#medium-town" />
            <use transform="translate(10.756 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 13.792 16.069)" href="#vp-2" />
        </>;
    });
...
const StationMasterTile11 = dependencies(BuildingUpgrade2Def,
    ...
    function StationMasterTile11() {
        return <>
            <use transform="translate(7.0162 2.6674)" href="#building-upgrade-2" />
            <use transform="translate(3.2507 15.699)" href="#cattle-3-5" />
            <use transform="translate(10.126 17.848)" href="#sans-colon" />
            <use transform="matrix(.85006 0 0 .85006 13.477 16.069)" href="#vp-1" />
        </>;
    });
...
const MediumTownTile1 = dependencies(SansTwoDef, SansXDef, HazzardTakeDef, function MediumTownTile1() {
    return <>
        ...
        <use transform="matrix(.66252 0 0 .66252 3.7551 4.0786)" href="#sans-two" />
        <use transform="matrix(.66252 0 0 .66252 5.9528 5.1585)" href="#sans-x" />
        ...
        <use transform="matrix(1.1794 0 0 1.1794 15.681 11.999)" href="#hazzard-take" />
    </>;
});

const MediumTownTile2 = dependencies(CoinDef, SerifFiveWhiteDef, CattleTake3Def, function MediumTownTile2() {
    return <>
        <use transform="matrix(.83141 0 0 .83141 5.5916 5.9253)" href="#coin" />
        <use transform="translate(7.9119 7.542)" href="#serif-five-white" />
        <use transform="matrix(1.298 0 0 1.298 16.419 12.891)" href="#cattle-take-3" />
    </>;
});
...
const MediumTownTile3 = dependencies(WorkerDef, TakeArrowDef, CoinDef, SerifTwoBaseDef, function MediumTownTile3() {
    return <>
        <use transform="matrix(1.7473 0 0 1.7473 8.2463 7.2911)" href="#worker" />
        <use transform="matrix(1.4966 0 0 1.4966 18.002 7.278)" href="#take-arrow" />
        <use transform="matrix(.83136 0 0 .83136 15.3 15.549)" href="#coin" />
        ...
        <use transform="matrix(1.0418 0 0 1.0418 18.542 17.096)" href="#serif-two-base"
            fill={costReductionFill} stroke={white} strokeWidth=".4" style={{ paintOrder: 'stroke' }} />
    </>;
});

const MediumTownTile4 = dependencies(BuildingUpgrade2Def, function MediumTownTile4() {
    return <use transform="matrix(2.0522 0 0 2.0522 5.3244 3.7703)" href="#building-upgrade-2" />;
});

const MediumTownTile5 = dependencies(EngineDef, SerifThreeWhiteDef, AdvanceArrowDef, function MediumTownTile5() {
    return <>
        <use transform="translate(5.0148 9.3271)" href="#engine" />
        <use transform="translate(11.289 11.815)" href="#serif-three-white" />
        <use transform="rotate(-90 17.516 -.96735)" href="#advance-arrow" />
    </>;
});
